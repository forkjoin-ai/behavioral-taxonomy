------------------------------ MODULE BehaviorLoop_the_physics_of_luck_probability_warping_1065_the_beginner_s_luck_loop ------------------------------
...
Edge_06_FORK ==
  ...
  /\ active' = UpdateActive({"loop_1065_context"}, {"loop_1065_context_branch", "loop_1065_then_branch", "loop_1065_operator_branch", "loop_1065_result_branch", "loop_1065_taxonomy_branch", "loop_1065_intervention_recognize", "loop_1065_intervention_interdict", "loop_1065_intervention_minimize"})
  /\ beta1' = beta1 + (Cardinality({"loop_1065_context_branch", "loop_1065_then_branch", "loop_1065_operator_branch", "loop_1065_result_branch", "loop_1065_taxonomy_branch", "loop_1065_intervention_recognize", "loop_1065_intervention_interdict", "loop_1065_intervention_minimize"}) - 1)
  /\ payloadPresent' = payloadPresent
  /\ consensusReached' = consensusReached \/ ({"loop_1065_context_branch", "loop_1065_then_branch", "loop_1065_operator_branch", "loop_1065_result_branch", "loop_1065_taxonomy_branch", "loop_1065_intervention_recognize", "loop_1065_intervention_interdict", "loop_1065_intervention_minimize"} \cap FOLD_TARGETS # {})
Edge_07_FOLD ==
  /\ CanFire({"loop_1065_context_branch", "loop_1065_then_branch", "loop_1065_operator_branch", "loop_1065_result_branch", "loop_1065_taxonomy_branch", "loop_1065_intervention_recognize", "loop_1065_intervention_interdict", "loop_1065_intervention_minimize"})
  /\ active' = UpdateActive({"loop_1065_context_branch", "loop_1065_then_branch", "loop_1065_operator_branch", "loop_1065_result_branch", "loop_1065_taxonomy_branch", "loop_1065_intervention_recognize", "loop_1065_intervention_interdict", "loop_1065_intervention_minimize"}, {"loop_1065_verdict"})
  /\ beta1' = 0
  /\ payloadPresent' = payloadPresent
